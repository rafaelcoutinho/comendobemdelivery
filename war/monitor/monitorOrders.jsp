...
<script type="text/javascript">
	        ...
	        dojo.require("com.copacabana.monitor.MonitorOrdersWidget");
...
<cb:body closedMenu="true">
	...
	<jsp:include page="monitorheader.jsp"><jsp:param
			name="isMonitoring" value="true"></jsp:param></jsp:include>

	<div dojoType="com.copacabana.monitor.MonitorOrdersWidget"	id="andamento"></div>
