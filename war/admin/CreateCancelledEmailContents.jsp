<%@page import="br.copacabana.usecase.OnOrderCancelled"%>
...
<%
	...
	String emailMsg = OnOrderCancelled.DEFAULT_MSG;
	if(((Configuration)cman.find(OnOrderCancelled.CONF_KEY_EMAIL_MSG, Configuration.class))!=null){	
		emailMsg = ((Configuration)cman.find(OnOrderCancelled.CONF_KEY_EMAIL_MSG, Configuration.class)).getValue();
	}
	
	String emailSubject = OnOrderCancelled.DEFAULT_SUBJECT;
	if(((Configuration)cman.find(OnOrderCancelled.CONF_KEY_EMAIL_SUBJECT, Configuration.class))!=null){	
		emailSubject = ((Configuration)cman.find(OnOrderCancelled.CONF_KEY_EMAIL_SUBJECT, Configuration.class)).getValue();
	}
...
<h2>Edicao do conteudo do email enviado para cliente qdo restaurante cancela pedido.</h2><br>
...
<form
	action="CreateCancelledEmail.jsp" onsubmit="moveValues();return false;" id="msgForm">
