		...
		<table id="cardapio">
			...
			<tbody>
				<tr id="450">
					...
					<td class="quantidade">
						<span>- </span>
						<span class="roundedInput text" style="height: 15px; width: 25px;">
							<img height="15px" width="25px" src="/ComendoBem/resources/img/campo50px.png"/>
							<input type="text" style="height: 15px; width: 20px;" value="" name="quantidade"/>
						</span>
						<span> +</span>
					</td>
				...
				<tr id="455">
					...
					<td class="quantidade">
						...
						<span class="roundedInput text" style="height: 15px; width: 25px;">
							<img height="15px" width="25px" src="/ComendoBem/resources/img/campo50px.png"/>
							<input type="text" style="height: 15px; width: 20px;" value="4" name="quantidade"/>
						</span>
						<span> +</span>
					</td>
					<td><a href="#">Selecionar</a></td>
				...
				<tr>
					<td colspan="5">
						<div class="caixa">
							<span class="titulo">Acompanhamentos</span>
							<input type="radio" />Batata Frita<br />
							<input type="radio" />Farofa<br />
							<input type="radio" />Polenta<br />							
						</div>
						
						<div class="caixa">
							<span class="titulo">Observações</span>
							<textarea rows="4">3 sem cebola e carne ao ponto 
1 com cebola e carne bem passada</textarea>
						</div>
					</td>
				</tr>
				<tr id="456">
