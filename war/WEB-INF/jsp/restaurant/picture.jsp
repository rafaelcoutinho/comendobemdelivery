	...
	var xhrArgs = {
		...
		load : function(data) {			
			...
			if(data.imgKeyString!=null){
				dojo.byId("imgPlace").src=data.imageUrl+".small"
				dojo.byId("largeImgPlace").src=data.imageUrl
			}
...
var formAction = '<%=blobstoreService.createUploadUrl("/uploadImage")%>';
...
<cb:body closedMenu="true">
	...
	<div id="dadosFuncionalidades">
		...
		<table><tr><td ><div style="width: 70px;height: 70px;border: thin red solid;"><img src="" id="largeImgPlace" style="display: none;position:absolute" onclick="hideLargeImg()" onmouseout="hideLargeImg()"><img src="" id="imgPlace" style="width: 70px" onmouseover="showLargeImg()"></div></td></tr><tr><td>
		 Alterar foto:<br/>
		<form action=""
