...
<%--
<script src="http://connect.facebook.net/pt_BR/all.js#xfbml=1"></script><div style="clear: both;text-align: center;">O que você acha do ${entity.restaurant.name}?

<div id="fb-root"></div>
<fb:comments href="/${entity.restaurant.uniqueUrlName}" num_posts="4" width="500"></fb:comments>
</div>
 --%>
</cb:body>
